...
const HOME_MENU_ITEMS = [
  ...
  { label: "List Property", link: "/list-property", ariaLabel: "List property" },
      ...
      <div className="relative z-20 min-h-screen">
        ...
        <div className="mx-auto flex min-h-screen w-full max-w-7xl items-center justify-center px-6 pb-14 pt-28 sm:px-10 lg:px-16">
          <main className="w-full text-center">
            <h1 className="mx-auto max-w-6xl text-balance text-4xl font-extrabold leading-[1.06] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl text-white">
              <span className="inline-flex flex-wrap items-center justify-center gap-2 md:gap-3">
                <LayoutTextFlip
                  ...
                  wordContainerClassName="rounded-2xl border border-white/18 bg-[linear-gradient(180deg,rgba(9,14,31,0.82)_0%,rgba(4,8,20,0.86)_100%)] backdrop-blur-xl px-6 py-4 text-4xl leading-[1.15] shadow-[0_20px_50px_rgba(2,6,23,0.42)] ring-1 ring-white/10 sm:text-5xl md:text-6xl lg:text-7xl font-extrabold"
                  wordClassName="font-extrabold tracking-tight leading-tight font-cigra"
                  wordColors={[
                    ["#06b6d4", "#1e40af"],
                    ["#10b981", "#065f46"],
                    ["#fb923c", "#92400e"]
