...
export const ButtonsCard = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group/btn relative flex h-60 w-full items-center justify-center overflow-hidden rounded-xl border border-neutral-100 bg-white dark:border-white/[0.2] dark:bg-black hover:border-neutral-200",
        className,
      )}
    >
