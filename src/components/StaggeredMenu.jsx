      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
            {brandLabel ? (
              <span className="sm-logo-text block text-[1.6rem] font-bold tracking-[0.12em] text-white">
                {brandLabel}
              </span>
            ) : (
              <img
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium" style={{ color: 'var(--sm-accent, var(--accent-500, #ff0000))' }}>Socials</h3>
                <ul
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 500; color: var(--sm-accent, var(--accent-500, #ff0000)); }
...
.sm-scope .sm-panel-item:hover { color: var(--aurora-3, #ff4d6d); }
.sm-scope .sm-panel-list[data-numbering] { counter-reset: smItem; }
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: var(--sm-accent, var(--accent-500, #ff0000)); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
